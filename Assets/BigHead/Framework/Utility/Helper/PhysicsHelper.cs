...
namespace BigHead.Framework.Utility.Helper
{
    public static class PhysicsHelper
    {
        ...
        public static Vector3 CapsuleMoveCast(Vector3 startPoint, Vector3 targetPoint, float capsuleHeight, float capsuleRadius, int castLayer, List<RaycastHit> hits, bool hitStop = false, float faultTolerantDistance = 0.01f)
        {
            var y = startPoint.y;
            ...
            if (Physics.CapsuleCast(point1, point2, capsuleRadius, direction, out var hit, distance + faultTolerantDistance, castLayer))
            {
                ...
                targetPoint = CapsuleMoveCast(stopPosition, stopPosition + offset, capsuleHeight, capsuleRadius, castLayer, hits);
            }
