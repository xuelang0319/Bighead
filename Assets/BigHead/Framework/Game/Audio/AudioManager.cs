...
public static class AudioManager
{
    ...
    static AudioManager()
    {
        ...
        {
            _listener.Broadcast(EnumListener.SoundVolume.ToString(), _soundVolume.Value);
        ...
        {
            _listener.Broadcast(EnumListener.MusicVolume.ToString(), _musicVolume.Value);
        ...
        {
            _listener.Broadcast(EnumListener.SoundMute.ToString(), _soundMuteState.Value);
        ...
        {
            _listener.Broadcast(EnumListener.MusicMute.ToString(), _musicMuteState.Value);
