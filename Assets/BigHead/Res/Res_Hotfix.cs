...
public static class AddressableHotfix
{
    ...
    private static void Broadcast(params object[] param) => Listener.Instance.Broadcast(SystemListenerKeys.HotfixResponse, param);
}
...
public partial class Res
{
    ...
    {
        _listener.Add(SystemListenerKeys.HotfixResponse, HotfixListener);
    }
    ...
    private void HotfixListener(object[] param)
    {
        ...
        switch (hotfixResponse)
        {
            ...
            case AddressableHotfix.EnumHotfix.Finish:
                _listener.Remove(SystemListenerKeys.HotfixResponse, HotfixListener);
