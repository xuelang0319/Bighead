...
namespace BigHead.Editor.Generate.GenTransformScript.Param
{
    public abstract class GenSelectParamBase
    {
        ...
        // 类修饰词
        public virtual Core.Editor.GenBasic.GenBasic.modifier ClassModifier { get; } = Core.Editor.GenBasic.GenBasic.modifier.Public;
        ...
        // 初始化方法修饰词
        public virtual Core.Editor.GenBasic.GenBasic.modifier FunctionModifier { get; } = Core.Editor.GenBasic.GenBasic.modifier.Private;

        // 属性修饰词
        public virtual Core.Editor.GenBasic.GenBasic.modifier PropertyModifier { get; } = Core.Editor.GenBasic.GenBasic.modifier.Private;
